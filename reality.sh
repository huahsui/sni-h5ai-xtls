...
echo "  - {name: Reality, server: $Zero, port: 443, type: vless, uuid: $UUID, network: tcp, tls: true, udp: true, flow: xtls-rprx-vision, server-name: $DOMIN, reality-opts: {public-key: $Two, short-id: 12a34b56c78d1a2b}, client-fingerprint: chrome}  "
echo
echo "----------------------------------------------------------------------------------------------------------------------------------------------"
